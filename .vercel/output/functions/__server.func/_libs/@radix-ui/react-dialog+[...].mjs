...
function useFocusScopeBranchRegistry() {
	...
	return {
		...
		registry: import_react.useMemo(() => ({
			add: /* @__PURE__ */ __name$2((node) => setNodes((prev) => prev.includes(node) ? prev : [...prev, node]), "add"),
			remove: /* @__PURE__ */ __name$2((node) => setNodes((prev) => prev.filter((current) => current !== node)), "remove")
		}), [])
	};
}
__name$2(useFocusScopeBranchRegistry, "useFocusScopeBranchRegistry");
...
__name$2(useFocusScopeBranch, "useFocusScopeBranch");
...
//#endregion
export { Primitive as C, useCallbackRef$1 as S, Presence as _, DialogOverlay as a, useLayoutEffect2 as b, DialogTrigger as c, useFocusGuards as d, FocusScope as f, useControllableState as g, useFocusScopeBranchRegistry as h, DialogDescription as i, hideOthers as l, useFocusScopeBranch as m, DialogClose as n, DialogPortal as o, FocusScopeBranchProvider as p, DialogContent as r, DialogTitle as s, Dialog as t, ReactRemoveScroll as u, Portal as v, dispatchDiscreteCustomEvent as w, DismissableLayer as x, useId as y };
