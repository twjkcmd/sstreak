...
import { C as Primitive, S as useCallbackRef, _ as Presence, b as useLayoutEffect2, d as useFocusGuards, f as FocusScope, g as useControllableState, h as useFocusScopeBranchRegistry, l as hideOthers, m as useFocusScopeBranch, p as FocusScopeBranchProvider, u as ReactRemoveScroll, v as Portal, w as dispatchDiscreteCustomEvent, x as DismissableLayer, y as useId } from "./react-dialog+[...].mjs";
...
function getDirectionAwareKey(key, dir) {
	if (dir !== Direction$1.RTL) return key;
	return key === "ArrowLeft" ? "ArrowRight" : key === "ArrowRight" ? "ArrowLeft" : key;
}
__name$2(getDirectionAwareKey, "getDirectionAwareKey");
function getFocusIntent(event, orientation, dir) {
	const key = getDirectionAwareKey(event.key, dir);
	if (orientation === Orientation.Vertical && ["ArrowLeft", "ArrowRight"].includes(key)) return;
	if (orientation === Orientation.Horizontal && ["ArrowUp", "ArrowDown"].includes(key)) return;
...
var MenuContentImpl = /* @__PURE__ */ import_react.forwardRef(/* @__PURE__ */ __name$1(function MenuContentImpl2(props, forwardedRef) {
	const { __scopeMenu, loop = false, trapFocus, onOpenAutoFocus, onCloseAutoFocus, disableOutsidePointerEvents, onEntryFocus, onEscapeKeyDown, onPointerDownOutside, onFocusOutside, onInteractOutside, onDismiss, disableOutsideScroll, children, ...contentProps } = props;
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DismissableLayer, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RovingFocusGroup, {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PopperContent, {
							...
							children: isModal ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FocusScopeBranchProvider, {
...
//#endregion
export { DropdownMenuItemIndicator as a, DropdownMenuRadioItem as c, DropdownMenuSubTrigger as d, DropdownMenuTrigger as f, createPopperScope as g, PopperContent as h, DropdownMenuItem as i, DropdownMenuSeparator as l, PopperAnchor as m, DropdownMenuCheckboxItem as n, DropdownMenuLabel as o, Popper as p, DropdownMenuContent as r, DropdownMenuPortal as s, DropdownMenu as t, DropdownMenuSubContent as u };
